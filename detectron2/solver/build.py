...
def build_optimizer_linear_eval(cfg: CfgNode, model: torch.nn.Module) -> torch.optim.Optimizer:
    """
    Build an optimizer from config.
    """
    params = get_default_optimizer_params_linear_eval(
        model,
        base_lr=cfg.SOLVER.BASE_LR,
        weight_decay=cfg.SOLVER.WEIGHT_DECAY,
        weight_decay_norm=cfg.SOLVER.WEIGHT_DECAY_NORM,
...
def get_default_optimizer_params_linear_eval(
    model: torch.nn.Module,
    base_lr,
    weight_decay,
    weight_decay_norm,
